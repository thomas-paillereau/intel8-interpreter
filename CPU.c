...
void cpu_init(CPU *cpu, int argc, char **argv, char *env, char *code,
              int sizeText, int sizeData)
{
    // Init
...
// Automaticly detect the register and update the value of it to the given
// argument
...
// Push the given argument (16 bits) in the memory and moves the SP register
// back
...
// Pop the given argument (16 bits) in the memory and moves the SP register
// forward
